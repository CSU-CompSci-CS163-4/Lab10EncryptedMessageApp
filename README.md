...
## Scenario 
You have been hired to build a simple console/terminal based program and will continue to expand on and add to your code over the next three weeks. For the first week you will read in messages from a file and search through an ArrayList storing those messages by subject, "to" line, and "from" line. Instructions can be found in the [javadoc](http://www.cs.colostate.edu/~cs163/javadoc/lab10/package-summary.html).
